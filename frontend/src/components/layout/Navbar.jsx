...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#27354E] bg-[#0D1424]/95 backdrop-blur-xl shadow-black/20 shadow-lg">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            type="button"
            className="inline-flex h-11 w-11 items-center justify-center rounded-3xl border border-[#27354E] bg-[#141C2E] text-[#B6C2D9] transition hover:border-[#3B82F6] hover:text-white md:hidden"
        ...
        <nav
          className={`flex flex-col gap-3 rounded-[1.75rem] border border-[#27354E] bg-[#0D1424]/90 p-4 shadow-[0_24px_60px_rgba(3,12,34,0.35)] transition-all md:flex-row md:items-center md:border-none md:bg-transparent md:p-0 md:shadow-none ${menuOpen ? 'block' : 'hidden'} md:block`}
        ...
        >
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive: isRouteActive }) =>
                    `relative inline-flex rounded-full px-4 py-2 text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3B82F6] ${
                      isActive || isRouteActive
                        ? 'bg-[#15253E] text-white shadow-sm shadow-[#3B82F6]/10'
                        : 'text-[#7C879C] hover:bg-[#141C2E] hover:text-white'
                    }`
                  }
                  onClick={(e) => {
                    setMenuOpen(false);
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3 border-t border-[#27354E] pt-4 md:mt-0 md:border-none md:pt-0">
            {settings?.github && (
              <a href={settings.github} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-[#27354E] bg-[#141C2E] px-4 py-2 text-sm text-[#B6C2D9] transition hover:border-[#3B82F6] hover:text-white">
            ...
            {settings?.resumeUrl && (
              <a href={settings.resumeUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#3B82F6] px-4 py-2 text-sm font-semibold text-[#060B17] transition hover:bg-[#2563EB]">
